...
### 1-1 ) 분석 목적
(사진 넣기)
- 일 / 주 / 월 단위의 기술적 지표를 활용하여 다음날 등락률 상승 여부를 예측하는 모델 구현현

### 1-2 ) 프로젝트 필요성 
- 주식 투자에 대한 관심이 높아지면서 주가 예측 정확도를 높이는 분석의 필요성 대두
- 기존 연구는 시간 및 일 단위의 기술적 지표를 활용하여 주가 예측을 진행
- 기존 연구와 달리 일 / 주 / 월 단위의 기술적 지표를 활용한 주가 예측을 시도하는데 의의
